...
export const puzzles = [
  // Size 5 puzzles
  parsePuzzle("Puzzle 1 (5x5)", ["C--AE", "---D-", "--D--", "-AE-B", "-CB--"]),
  parsePuzzle("Puzzle 2 (5x5)", ["---AB", "--CB-", "A----", "EC-DE", "----D"]),

  // Size 6 puzzles
  parsePuzzle("Puzzle 1 (6x6)", [
    "-----E",
    "------",
    "-DA---",
    "---B-D",
